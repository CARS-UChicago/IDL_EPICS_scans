pro setup_id_vert_mirror

; Define mirror assembly motors
  us_pitch   = obj_new('epics_motor','13IDA:m20')
  ds_pitch   = obj_new('epics_motor','13IDA:m21')
  sum_height = obj_new('epics_motor','13IDA:pm5')
  dif_pitch  = obj_new('epics_motor','13IDA:pm6')
  us_horiz   = obj_new('epics_motor','13IDA:m22')
  ds_horiz   = obj_new('epics_motor','13IDA:m23')
